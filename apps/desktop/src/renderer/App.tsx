...
export function App() {
  ...
  const commands = [
    {label: 'Open Workflow Studio', action:()=>setStudioOpen(true)},
  ...
  if(studioOpen)return <WorkflowStudio onOpenIDE={()=>setStudioOpen(false)}/>;
